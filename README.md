...
Status: **all four engines shipped and validated** — batch STT, diarization, TTS,
and realtime (WebSocket). Next up is WebRTC transport and a `/v1/capabilities`
manifest — see [`docs/PLAN.md`](docs/PLAN.md).
